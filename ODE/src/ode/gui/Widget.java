...
public class Widget extends Node<Widget> {
	...
	private Action pointerPress;
	private Action pointerRelease;
	private Action pointerClick;
	//=============================================================================================
	...
	public void onPointerEnter(Action action) {
		this.pointerEnter = action;
	}
	//=============================================================================================

	//=============================================================================================
	public void onPointerExit(Action action) {
		this.pointerExit = action;
	}
	//=============================================================================================

	//=============================================================================================
	public void onPointerPress(Action action) {
		this.pointerPress = action;
	}
	//=============================================================================================

	//=============================================================================================
	public void onPointerRelease(Action action) {
		this.pointerRelease = action;
	}
	//=============================================================================================

	//=============================================================================================
	public void onPointerClick(Action action) {
		this.pointerClick = action;
	}
	//=============================================================================================
	
	//=============================================================================================
	public void firePointerEnter(Msg msg) {
		Logger.log(Level.DEBUG, "ENTER");
		if (pointerEnter != null) {
			pointerEnter.perform(msg, this);
		}
	}
	//=============================================================================================

	//=============================================================================================
	public void firePointerExit(Msg msg) {		
		Logger.log(Level.DEBUG, "EXIT");
		if (pointerExit != null) {
			pointerExit.perform(msg, this);
		}
	}
	//=============================================================================================

	//=============================================================================================
	public void firePointerPress(Msg msg) {		
		Logger.log(Level.DEBUG, "PRESSED");
		if (pointerPress != null) {
			pointerPress.perform(msg, this);
		}
	}
	//=============================================================================================

	//=============================================================================================
	public void firePointerRelease(Msg msg) {		
		Logger.log(Level.DEBUG, "RELEASED");
		if (pointerRelease != null) {
			pointerRelease.perform(msg, this);
		}
	}
	//=============================================================================================

	//=============================================================================================
	public void firePointerClick(Msg msg) {		
		Logger.log(Level.DEBUG, "CLICKED");
		if (pointerClick != null) {
			pointerClick.perform(msg, this);
		}
	}
	//=============================================================================================
